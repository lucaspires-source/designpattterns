...
function ShapeVisitor() {
    this.visitCircle = function (circle) {
        console.log(`Area of ${circle.type}: ${circle.area()}`);
    };

    this.visitRectangle = function (rectangle) {
        console.log(`Area of ${rectangle.type}: ${rectangle.area()}`);
    };
}
...
const shapeVisitor = new ShapeVisitor();
